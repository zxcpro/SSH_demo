...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
				<form name="loginform" action="exchange/loginAction" accept-charset="utf-8" id="login_form" class="loginForm" method="post"><input type="hidden" name="did" value="0"/>
  ...
  <!--注册-->
    ...
    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="exchange/registerAction" method="post">
        <ul class="reg_form" id="reg-ul">
        	<div id="userCue" class="cue">请填写注册信息：</div>
                <li>
